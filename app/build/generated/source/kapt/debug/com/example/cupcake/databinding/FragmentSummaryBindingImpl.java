...
public class FragmentSummaryBindingImpl extends FragmentSummaryBinding implements com.example.cupcake.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.quantity_label, 6);
        sViewsWithIds.put(R.id.divider1, 7);
        sViewsWithIds.put(R.id.flavor_label, 8);
        sViewsWithIds.put(R.id.divider2, 9);
        sViewsWithIds.put(R.id.pickup_label, 10);
    ...
    private FragmentSummaryBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback15 = new com.example.cupcake.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.sendButton.setOnClickListener(mCallback15);
        }
        if ((dirtyFlags & 0x61L) != 0) {
            // api target 1
